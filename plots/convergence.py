...
df_MCP = pd.read_csv("../benchmarks/parallel/monte_carlo_convergence_parallel.csv")
...
ax.loglog(df_MC["M"], df_MC["standard_error"], marker="o", linestyle="-", label="Erreur Standard")
ax.loglog(df_MC["M"], df_MC["error"], marker="s", linestyle="--", label="Erreur Absolue (Monte Carlo vs Black-Scholes)")

ax.loglog(df_MCP["M"], df_MCP["standard_error"], marker="o", linestyle="-", label="Erreur Standard parallel")
ax.loglog(df_MCP["M"], df_MCP["error"], marker="s", linestyle="--", label="Erreur Absolue (Monte Carlo parallelized vs Black-Scholes")
...
ax.loglog(df_MCP["time"], df_MCP["error"], marker="s", linestyle="--", label="Erreur Absolue (MC paralelizd vs Black-Scholes)")
